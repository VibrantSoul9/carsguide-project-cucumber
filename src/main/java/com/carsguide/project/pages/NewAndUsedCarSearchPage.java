...
public class NewAndUsedCarSearchPage extends Utility {
    ...
    public String getWelcomText(){
        log.info("Getting welcom text from New and Used Car Search page :" + welcomeText.toString());
        return getTextFromElement(welcomeText);
    }
    public void selectMakesFromDropDown(String option){
        selectByVisibleTextFromDropDown(modelsDropDown, option);
    ...
    public void selectLocationFromDropDown(String option){
        ...
        log.info("Selection "+ option + " in location dropdown :" + locationsDropDown.toString());
    }
    public void selectPriceFromDropDown(String option){
        selectByVisibleTextFromDropDown(priceDropDown, option);
        log.info("Selecting "+ option + " in location dropdown:" + priceDropDown.toString());
    }
